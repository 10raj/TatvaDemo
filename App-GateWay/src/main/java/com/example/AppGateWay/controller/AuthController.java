...
import com.example.AppGateWay.config.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(
      ...
      // String[] cliams = JwtUtils.getAllClaimsFromToken(client.getAccessToken().getTokenValue());
